    ...
    <main className="min-h-[calc(100vh-56px)] flex items-center justify-center">
      <div className="w-full max-w-md px-4 py-6 space-y-3 text-white">
        ...
        <div className="grid gap-3">
          ...
          <div className="rounded-2xl bg-neutral-900 border border-lernex-green p-5">
            ...
            <button className="mt-3 w-full py-3 rounded-2xl bg-lernex-green hover:bg-green-600 transition">Continue</button>
          </div>
        </div>
      </div>
    </main>
