export default function Footer() {
  return (
    <footer className="mt-24 border-t border-neutral-200 bg-white/60 text-neutral-900 shadow-inner backdrop-blur-lg dark:border-white/10 dark:bg-neutral-950/60 dark:text-white">
      <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-4 px-6 py-10 text-sm md:flex-row">
        ...
        <div className="flex gap-4">
          <a
            ...
            className="text-neutral-600 hover:text-neutral-900 hover:underline dark:text-neutral-400 dark:hover:text-white"
          >
            Privacy
          </a>
          <a
