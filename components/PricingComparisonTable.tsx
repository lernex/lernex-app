...
const featureCategories: FeatureCategory[] = [
  {
    ...
    icon: '📚',
    features: [
      { name: 'AI-generated micro-lessons', free: 'Daily quota', plus: 'Higher monthly quota', premium: 'Highest monthly quota' },
      { name: 'AI model quality', free: 'Standard (GPT-OSS-20B)', plus: 'Advanced (GPT-OSS-120B)', premium: 'Advanced (GPT-OSS-120B)', highlight: true },
      { name: 'Model speed options', free: 'Fast & Slow', plus: 'Fast & Slow', premium: 'Fast & Slow' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'For You Page (FYP)', free: 'Within daily quota', plus: 'Within monthly quota', premium: 'Higher monthly quota', highlight: true },
      { name: 'Model intelligence', free: '20B parameters', plus: '120B parameters (6x)', premium: '120B parameters (6x)', highlight: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'OCR image quality', free: 'Compressed (75%)', plus: 'Standard (80%)', premium: 'High-detail (95%+)', highlight: true },
      { name: 'Upload pipeline', free: 'Fast (cost-optimized)', plus: 'Balanced', premium: 'Premium (quality-focused)' },
      { name: 'Audio transcription', free: true, plus: true, premium: true },
      { name: 'Voice input', free: true, plus: true, premium: true },
      { name: 'Batch upload processing', free: 'Basic compression', plus: 'Balanced compression', premium: 'Minimal compression' },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Leaderboard styling', free: 'Standard', plus: 'Indigo gradient highlight', premium: 'Gold gradient highlight', highlight: true },
      { name: 'Profile avatar border', free: 'Basic border', plus: 'Indigo ring + glow', premium: 'Amber ring + glow', highlight: true },
      { name: 'Tier badge display', free: false, plus: 'Sparkles icon badge', premium: 'Crown icon badge', highlight: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Advanced feature access', free: 'Standard features', plus: 'Enhanced features', premium: 'All features + team tools', highlight: true },
      { name: 'Feature request priority', free: 'Basic', plus: 'Prioritized', premium: 'High priority' },
      { name: 'Visual profile cosmetics', free: 'Standard', plus: 'Indigo theme + Sparkles badge', premium: 'Gold theme + Crown badge', highlight: true },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: '📈',
    features: [
      { name: 'Generation cost limit', free: '$0.06 per day', plus: '$2.50 per month', premium: '$5.00 per month', highlight: true },
      { name: 'Limit refresh period', free: 'Every 24 hours', plus: 'Every 30 days', premium: 'Every 30 days', highlight: true },
      { name: 'Typical lessons per period', free: '3-5 daily', plus: '40-80 monthly', premium: '80-160 monthly' },
